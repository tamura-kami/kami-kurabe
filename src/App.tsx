...
function App() {
  ...
  const [comparePosition, setComparePosition] =
    useState<ComparePosition>("top-left");
          ...
          <div className="comparison-panel">
            ...
            <div className="compare-controls" aria-label="比較設定">
              <div className="compare-control-group">
                ...
                <div className="position-switch">
                  <button
                    type="button"
                    aria-pressed={comparePosition === "center"}
                    className={comparePosition === "center" ? "selected" : ""}
                    onClick={() => setComparePosition("center")}
                  >
                    中央で比較
                  </button>
                  <button
                    type="button"
                    aria-pressed={comparePosition === "top-left"}
                    className={comparePosition === "top-left" ? "selected" : ""}
                    onClick={() => setComparePosition("top-left")}
                  >
                    左上を基準
                  </button>
                </div>
              ...
              <div className="compare-control-group">
                ...
                <div className="position-switch">
                  <button
                    type="button"
                    aria-pressed={orientation === "default"}
                    className={orientation === "default" ? "selected" : ""}
                  ...
                  <button
                    type="button"
                    aria-pressed={orientation === "long-edge-horizontal"}
                    className={
                      orientation === "long-edge-horizontal" ? "selected" : ""
                    }
                    onClick={() => setOrientation("long-edge-horizontal")}
                  >
                    長辺を横
                  </button>
                </div>
            ...
            <div
              className={`paper-stage ${
                comparePosition === "top-left" ? "align-top-left" : ""
              }`}
              aria-label={`${
                comparePosition === "center" ? "中央" : "左上"
              }を基準に選択した紙の形を重ねて表示`}
            >
              ...
              {papers.map((paper, index) => {
                ...
                return (
                  <div
                    key={paper.name}
                    className={`paper-shape${active ? " is-active" : ""}`}
                    style={{
              ...
              {selected.length === 0 && (
                <p className="stage-hint">下から紙を選ぶと比較できます</p>
              )}
            ...
            <div className="comparison-caption">
              <span className="caption-dot" /> 紙を選択すると重ねて表示します{" "}
